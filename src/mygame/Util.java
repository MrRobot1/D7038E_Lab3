...
public class Util {
     ...
     */
    @Serializable
    public static class VelocityMessage extends MyAbstractMessage {
    ...
    /**
     * PositionMessage is sent by the server to all clients.
     *
     * 
     */
    @Serializable
    public static class PositionMessage extends MyAbstractMessage {
